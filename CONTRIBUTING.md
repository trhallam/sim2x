...
Ready to contribute? Here's how to set up `sim2x` for local development.

1. Download a copy of `sim2x` locally.
...
Please note that the `sim2x` project is released with a
